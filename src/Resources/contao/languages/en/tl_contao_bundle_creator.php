...
$GLOBALS['TL_LANG']['tl_contao_bundle_creator']['backendmodulecategory'] = ["Backendmodul-Kategorie", "Geben Sie die Kategorie in snakecase an."];
...
$GLOBALS['TL_LANG']['tl_contao_bundle_creator']['backendmoduletype'] = ["Backendmodul-Typ", "Geben Sie den Namen des Modules in snakecase an."];
...
$GLOBALS['TL_LANG']['tl_contao_bundle_creator']['frontendmodulecategory'] = ["Frontendmodul-Kategorie (snakecase)", "Geben Sie die Kategorie in camelcase an."];
...
$GLOBALS['TL_LANG']['tl_contao_bundle_creator']['frontendmoduletype'] = ["Frontendmodul-Typ (snakecase mit \"_module\" als suffix)", "Geben Sie den Namen des Modules in snakecase an."];
